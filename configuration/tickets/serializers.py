...
class TicketSerializer(serializers.ModelSerializer):
    ...
    owner_organization_id=serializers.IntegerField(source="owner_organization.id",read_only=True)

    class Meta:
        model = Ticket
        fields = "__all__"
        extra_kwargs = {
            "owner_organization": {"write_only": True, "required": False},
            "organization": {"write_only": True, "required": False},
        }
